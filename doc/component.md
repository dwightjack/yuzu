...
-   `el` **([string][2] \| [HTMLElement][3])** Component's root element
...
-   `refCfg` **[object][1]** A child component configuration object
    ...
    -   `refCfg.el` **([string][2] \| [HTMLElement][3])** Child component root element. Ignored if `refCfg.component` is a component instance
